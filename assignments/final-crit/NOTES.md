...
"Hi, I'm Daize, NetID REDACTED, solo project. This is **Project Utopia** — a minimalist colony simulation where the player **doesn't micromanage individuals**. You build infrastructure and set high-level priorities; **autonomous agents** living on a tile grid figure out the rest. Every living thing — workers, visitors, predators, herds — is rendered as a simple sphere on a 96×72 tile grid."
