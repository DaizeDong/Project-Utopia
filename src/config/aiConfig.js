...
export const GROUP_POLICY_CONTRACTS = Object.freeze({
  [GROUP_IDS.WORKERS]: Object.freeze({
    allowedIntents: Object.freeze(["farm", "wood", "deliver", "eat", "wander"]),
    allowedTargets: Object.freeze(["warehouse", "farm", "lumber", "road", "depot", "frontier", "safety"]),
...
export const DEFAULT_GROUP_POLICIES = Object.freeze({
  [GROUP_IDS.WORKERS]: {
    ...
    riskTolerance: 0.35,
    targetPriorities: { warehouse: 1.5, farm: 1.0, lumber: 1.0, road: 1.05, depot: 1.2, frontier: 0.9, safety: 1.2 },
    ttlSec: 24,
